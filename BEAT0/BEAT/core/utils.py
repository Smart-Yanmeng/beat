    ...
    if bundle[0] == 'O':
        ...
        if c[0]=='i':
            ...
            if t2 == 'B':
                ...
                buf.write(thresprf.serialize1(sig))
                buf.write(thresprf.serialize1(proof_c))
                buf.write(thresprf.serialize1(proof_z))
                buf.seek(0)
                return buf.read()
            else:
...
def deserializeEnc(r):
    ...
    return ( r[:EC_SERIALIZED_1], r[EC_SERIALIZED_1:EC_SERIALIZED_1+EC_LABEL_LENGTH], 
        ...
        deserialize(r[EC_SERIALIZED_1+EC_LABEL_LENGTH+EC_SERIALIZED_2:EC_SERIALIZED_1+EC_LABEL_LENGTH+EC_SERIALIZED_2*2]),
        deserialize(r[EC_SERIALIZED_1+EC_LABEL_LENGTH+EC_SERIALIZED_2*2:EC_SERIALIZED_1+EC_LABEL_LENGTH+EC_SERIALIZED_2*3]),
